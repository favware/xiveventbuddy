...
Some recent builds also expose AI-assisted SQL authoring. Treat these as interactive Studio features rather than a
replacement for checked-in migrations or application queries.
